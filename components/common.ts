  ...
  return css`
    @font-face {
      ...
      src: local("montserrat"),
        ...
        url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/font/montserrat-v18-latin-${weight}.ttf") format("truetype"),
        url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/font/montserrat-v18-latin-${weight}.svg#Montserrat") format("svg");
    }
  `;
});
  ...
  return css`
    @font-face {
      ...
      src: url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/font/noto-sans-kr-v21-korean-${weight}.eot?#iefix") format("embedded-opentype"),
        ...
        url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/font/noto-sans-kr-v21-korean-${weight}.svg#NotoSansKR") format("svg");
    }
  `;
});
...
const forVariables = (obj: any, fn: any) => Object.entries(obj).map(fn).join("\n");

const createVariables = (property: any, varName: any) => forVariables(property, ([name, value]: any) => `--${varName}-${name} : ${value};`);
  ...
  * {
  ...
  .box_custom_chk {
    ...
    > input[type="checkbox"] {
      ...
      &:checked + label {
        background: url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/images/common/ico_chk_on.webp") no-repeat left 0 / 4rem;
      }
    }
    ...
    > label {
      ...
      height: 4rem;
      padding-left: 5.5rem;
      background: url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/images/common/ico_chk.webp") no-repeat left 0 / 4rem;
      font-size: 2rem;
      line-height: 3.6rem;
  ...
  .wrap_zoom {
    ...
    .magnifier {
      ...
      position: absolute;
      border-radius: 100%;
      box-shadow: 0 0 0 3px rgba(255, 255, 255, 0.85), 0 0 0.3rem 0.3rem rgba(0, 0, 0, 0.25);
      display: none;
    }
  }
  //
