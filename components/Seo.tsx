...
export const Seo = [
  {
    canonical: "https://gopizzahometest.vercel.app",
    title: "1인피자의 시작, 고피자",
    ...
    openGraph: {
      ...
      description: "고피자에서는 다양한 맛의 피자와 함께 즐거운 시간을 제공합니다. 메뉴와 매장을 확인하고, 창업에 대한 정보를 얻으세요.",
      url: "https://gopizzahometest.vercel.app",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/main",
    ...
    openGraph: {
      ...
      title: "FAST, BUT DELICIOUS  | 고피자",
      description: "고피자는 혁신적인 1인 피자 브랜드로, 빠르고 맛있는 피자를 제공합니다. 다양한 취향을 반영한 맛있는 피자와 함께 즐거운 외식 경험을 선사해드립니다.",
      url: "https://gopizzahometest.vercel.app/main",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/brand",
    title: "OUR STORY | 고피자",
    ...
    openGraph: {
      ...
      title: "OUR STORY | 고피자",
      description: "당신이 원하던 1인 피자, GOPIZZA! 빠르고 간편하게 즐길 수 있는 고피자는 신선한 재료와 고피자만의 AI오븐으로 최고의 맛과 서비스를 제공합니다.",
      url: "https://gopizzahometest.vercel.app/brand",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/brand/howwemake",
    title: "HOW WE MAKE | 고피자",
    description: "고피자의 최고의 맛을 자랑하는 피자를 만들기 위한 제조과정과 비결을 알려드립니다. 경험하세요, 고피자의 혁신과 맛의 차이를!",
    openGraph: {
      type: "website",
      title: "HOW WE MAKE | 고피자",
      description: "고피자의 최고의 맛을 자랑하는 피자를 만들기 위한 제조과정과 비결을 알려드립니다. 경험하세요, 고피자의 혁신과 맛의 차이를!",
      url: "https://gopizzahometest.vercel.app/brand/howwemake",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/brand/goglobal",
    title: "GO GLOBAL | 고피자",
    ...
    openGraph: {
      ...
      title: "GO GLOBAL | 고피자",
      description: "한국을 시작으로 싱가포르, 인도, 홍콩, 인도네시아 등 전 세계적으로 인기 있는 고피자! 글로벌 시장에서 성장하고 있습니다.",
      url: "https://gopizzahometest.vercel.app/brand/goglobal",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/find",
    title: "매장찾기 | 고피자",
    description:
    ...
    openGraph: {
      ...
      description:
        "가까운 고피자 매장을 찾아보세요! 자신의 위치를 기반으로 자동으로 찾아드립니다. 혹은 도/시와 구/군을 선택하거나 검색어를 입력하여 가장 가까운 고피자 매장을 찾을 수 있습니다.",
      url: "https://gopizzahometest.vercel.app/find",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/event",
    title: "PROMOTION | 고피자",
    ...
    openGraph: {
      ...
      title: "PROMOTION | 고피자",
      description: "고피자의 최신 이벤트 및 프로모션 정보를 확인하세요! 배달 주문 할인, 파워타임 프로모션, 배달의 민족 프로모션 등 다양한 이벤트가 진행 중입니다.",
      url: "https://gopizzahometest.vercel.app/event",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/event/video",
    title: "VIDEO | 고피자",
    ...
    openGraph: {
      ...
      title: "VIDEO | 고피자",
      description: "고피자와 관련된 다양한 영상들을 보실 수 있습니다.",
      url: "https://gopizzahometest.vercel.app/event/video",
      images: [
        {
  ...
  },
  {
    ...
    openGraph: {
      ...
      title: "단체주문 | 고피자",
      description: "GoPizza에서 단체주문 및 제휴문의를 편리하게 진행하세요. 행사, 기업, 학교 등 다양한 단체행사를 위한 피자 주문과 제휴를 지원합니다.",
      url: "https://gopizzahometest.vercel.app/order",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/order/partner",
    title: "기업제휴 | 고피자",
    description: "기업 제휴 문의 작성. 필수 입력 항목을 작성하신 후 문의내용을 남겨주시면 빠르게 연락드리겠습니다.",
    openGraph: {
      type: "website",
      url: "https://gopizzahometest.vercel.app/order/partner",
      title: "기업제휴 | 고피자",
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/order/location",
    title: "찾아오시는길 | 고피자",
    description: "고피자 글로벌 본사에 찾아오시는 길을 안내합니다.",
    openGraph: {
      type: "website",
      url: "https://gopizzahometest.vercel.app/order/location",
      title: "찾아오시는길 | 고피자",
      description: "고피자 글로벌 본사에 찾아오시는 길을 안내합니다.",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/start",
    title: "창업경쟁력 | 고피자",
    description:
    ...
    openGraph: {
      ...
      description:
        "고피자의 창업경쟁력과 매출성장 전략을 확인하세요. 독보적인 1인 피자의 선두주자, 혁신적인 오퍼레이션, 소자본 창업 및 고매출 실현! 본사의 지원과 함께 성공적인 창업을 시작하세요.",
      url: "https://gopizzahometest.vercel.app/start",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/start/guide",
    title: "창업안내 | 고피자",
    description:
    ...
    openGraph: {
      ...
      description:
        "고피자 가맹안내에서 소자본 창업, 매출 향상 전략, 효율적인 오픈 절차를 확인하세요. 창업문의부터 인테리어 공사 및 본사 교육까지 일정 소요기간 내에 창업을 시작할 수 있습니다.",
      url: "https://gopizzahometest.vercel.app/start/guide",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/start/technology",
    title: "혁신기술력 | 고피자",
    description:
    ...
    openGraph: {
      ...
      description:
        "고피자의 혁신 기술력과 창업 지원 시스템을 확인하고, 성공적인 피자 프랜차이즈 창업을 시작하세요. 크리스피 빠삭 도우, 고븐, 고봇 스테이션, AI 스마트 토핑 테이블 등 독보적인 기술력을 경험해보세요.",
      url: "https://gopizzahometest.vercel.app/start/technology",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/media",
    title: "CEO & 언론보도 | 고피자",
    description:
    ...
    openGraph: {
      ...
      description:
        "고피자 가맹안내 페이지에서 CEO의 메시지와 언론보도를 통해 고피자의 혁신적인 기술과 성장 스토리를 확인하세요. 착한 마음으로 성실하게 고피자를 전 세계적인 피자 브랜드로 성장시키는 임재원 대표님의 철학을 만나보세요.",
      url: "https://gopizzahometest.vercel.app/start/media",
      images: [
        {
...
export const MenuSeo = [
  {
    canonical: "https://gopizzahometest.vercel.app/menu",
    title: "PIZZA | 고피자",
    description:
    ...
    openGraph: {
      ...
      description:
        "고피자에서는 다양한 종류의 맛있는 피자와 함께하는 즐거운 시간을 제공합니다. 치킨앤콘 반반 피자, 슈퍼 콤비네이션 피자, K-불고기 피자 등 다양한 메뉴를 만나보세요.",
      url: "https://gopizzahometest.vercel.app/menu",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/menu/pasta",
    title: "PASTA | 고피자",
    description:
    ...
    openGraph: {
      ...
      url: "https://gopizzahometest.vercel.app/menu/pasta",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/menu/tteokbokki",
    ...
    openGraph: {
      ...
      url: "https://gopizzahometest.vercel.app/menu/tteokbokki",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/menu/sides",
    title: "SIDES | 고피자",
    description:
    ...
    openGraph: {
      ...
      url: "https://gopizzahometest.vercel.app/menu/sides",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/menu/set",
    title: "SET | 고피자",
    description:
    ...
    openGraph: {
      ...
      description:
        "혼자서도, 다 같이도 즐겁고 맛있는 고피자 세트 메뉴! 1인 피자 세트부터 친구들과 함께 나눠 먹기 좋은 2.5인 피자 세트까지 다양한 메뉴와 조합으로 만나보세요.",
      url: "https://gopizzahometest.vercel.app/menu/set",
      images: [
        {
  ...
  {
    canonical: "https://gopizzahometest.vercel.app/menu/powertime",
    ...
    openGraph: {
      ...
      title: "POWER TIME | 고피자",
      description: "고피자 파워타임 메뉴를 즐겨보세요! 오리지널 페퍼로니 피자, 허니 고르곤졸라 피자, 이달의 피자 등 다양한 메뉴를 특별한 할인 가격으로 경험해 보십시오.",
      url: "https://gopizzahometest.vercel.app/menu/powertime",
      images: [
        {
