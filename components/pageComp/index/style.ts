...
export const IndexWrap = styled.main`
  ...
  * {
  ...
  .box_goto {
    ...
    &:nth-of-type(1) {
      background: url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/images/index/bg_main1x2.webp") no-repeat center bottom / cover;
      a .txt {
        padding-right: 5.7rem;
      }
    }
    &:nth-of-type(2) {
      background: url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/images/index/bg_main2x2.webp") no-repeat center bottom / cover;
      a .txt {
