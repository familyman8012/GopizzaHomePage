...
const countryImg = Array.from({ length: 5 }).map(
  (_, i) =>
    css`
      &:nth-of-type(${i + 1}) {
        background: url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/images/brand/goglobal/img_global${i + 1}x2.webp?v=2") no-repeat left top / 100%;
        .country {
          background: url("https://dev-gopizza-homepage.s3.ap-northeast-2.amazonaws.com/ui/images/brand/goglobal/ico_global${i + 1}.webp?v=2") no-repeat left top / 100%;
        }
      }
    `
);
