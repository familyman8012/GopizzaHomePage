      ...
      <FormWrap onSubmit={handleSubmit(onSubmit)}>
        ...
        {type === "group" && (
          <div className="list_form_notice">
            ・ 홈페이지를 통한 단체 주문 신청은 배송일 3일 이전까지 가능합니다
            <br />
            <span style={{ opacity: 0 }}>・</span> (당일 및 익일 주문은 매장으로 문의하세요)
            <br />
            ・ 단체주문은 50개 이상부터 주문 가능합니다.
            <br />
            ・ 대량 주문 시(200개 이상), 납품일 기준 5일 전까지 주문.
            <br />
            ・ 대량 주문 취소/수량 변경 최대 4일전 까지 가능. (위반 시 결제금액의 40% 위약금)
            <br />
            ・ 결제일 : 피자 납품 당일 결제 원칙(사전 결제 가능)
            <br />・ 결제방식 : 매장방문 카드결제/계좌이체/현금결제 ( 지출증빙서류 발급 가능 / 전자세금계산서, 현금영수증 )
          </div>
        )}
