      ...
      <div className="wrap_message">
        <div className="inner">
          ...
          <p>
            ...
            고피자 대표이사 임재원입니다.
            <br />
            ‘왜 피자는 오래 걸리며 비싸고 커야만 할까?’라는
            <br className="mobileline" /> 작은 생각에서 시작해 <br className="pcline" />
            고피자를 전 세계적인 피자
            <br className="mobileline" /> 브랜드로 키우겠다는 목표 하나로 푸드트럭을
            <br />
            시작으로 지금까지 열심히 성장해왔습니다.
            <br />
            <br />
            최고의 제품과 혁신적인 기술로 고객들에게 행복
            <br className="mobileline" />한 경험을 제공하는 것이 <br className="pcline" />
            고피자의 가장 중요한
            <br className="mobileline" /> 임무이지만, 그 방식에 있어 항상 선한 마음으로
            <br />
            투명하게 경영하는 것이 우리 고객과 점주님,
            <br className="mobileline" /> 그리고 주주와 임직원들에
            <br className="pcline" />
            대한 제 철학입니다.
            <br />
            <br />
