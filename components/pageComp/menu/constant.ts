...
export const menuDetail: IMenuDetail = {
  ...
  pizza14: {
    ...
    name: "클래식 마르게리타 피자",
    enName: "Classic Margherita Pizza",
    txt: `토마토 소스와 바질오일이 어우러져 신선한
    풍미가 가득, 기본에 충실한 맛!`,
    ingredients: ["토마토 소스", "바질 오일", "마리네이드 토마토", "모짜렐라 치즈", "그라나파다노 치즈"],
  },
  pizza15: {
    id: 15,
    category: "pizza",
  ...
  pasta1: {
    ...
    name: "토마토 치즈 파스타",
    enName: "Tomato Cheese Pasta",
    txt: `신선한 토마토소스에 자연 치즈가 듬뿍
    들어간 토마토 베이스 파스타`,
    ingredients: ["토마토 소스", "올리브 오일", "피망", "양파", "모짜렐라 치즈", "체다 치즈"],
  },
  pasta2: {
    id: 2,
    category: "pasta",
